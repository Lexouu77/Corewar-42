...
/*   Updated: 2016/09/13 15:22:21 by ahamouda         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			display_usage(void)
{
	...
	ft_printf("%[[FG_GRE,SP_RST]s [1|2|4|8|16] (Verbosity Mod) | ", "-v");
	...
	ft_printf("-Dump and Graphic mod (Shell) bonuses can't work together.\n");
	ft_printf("-Graphic will automatically set Color + Log File and ");
	ft_printf("unset Graphic (Shell) + Dump.\n");
	ft_printf("-Press [SPACE] to pause the vm in Graphic mode.\n");
}
