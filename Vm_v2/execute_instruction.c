...
/*   Updated: 2016/06/14 14:46:42 by ahamouda         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		execute_instruction(t_vm_data *arena)
{
	...
	static void		(*f[16])(t_vm_data *, t_proc *) = {live, load, store,
		add, sub, do_and, do_or, do_xor, zjump, /*load_index*/store_index, store_index,
		do_fork, /*long_load*/load, /*load_index*/store_index, long_fork, aff};
